    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample07">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                    <a id="nav-link" class="nav-link navbar-brand" href="inicio2.php">Maquinaria</a>
                </li>
                <li class="nav-item">
            ...
            <form class="d-flex my-2 my-lg-0">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a id="nav-link" class="nav-link navbar-brand" href="login.php">Iniciar sesion</a>
                    </li>
                    <li class="nav-item">
                        <a id="nav-link" class="nav-link navbar-brand" href="register">Registrarte</a>
                    </li>
                </ul>
            </form>
        </div>
