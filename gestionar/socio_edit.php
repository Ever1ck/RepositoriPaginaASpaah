...
<form method="post" id="formulario">
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="form-group">
          <label class="mt-4" style="color: black">Correo Electrónico</label>
          <input type="password" class="form-control" name="password" placeholder="Ingrese contraseña" value="<?= $data[6] ?>">
      </div>
    <div class="form-group">
      <label class="mt-4" style="color: black">Dirección</label>
      <input type="text" class="form-control" name="direccion" placeholder="Ingrese dirección" required value="<?= $data[7] ?>">
    </div>
    <div class="form-group">
      <label class="mt-4" style="color: black">Celular</label>
      <input type="text" class="form-control" name="celular" placeholder="Ingrese celular" value="<?= $data[8] ?>">
    </div>
    <br>
