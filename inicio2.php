...
<!-- Header -->
<header class="container-fluid py-2 pt-4 mb-3" style="height: 100vh; background-image: url('./img/fondo2.jpg');">
    <!-- NavBar -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-success fixed-top" style="height: 80px; width: ">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse pt-4 pt-lg-0" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a id="nav-link-home" class="nav-link navbar-brand active" href="index">Home</a>
                    </li>
                    <li class="nav-item">
                        <a id="nav-link" class="nav-link navbar-brand" href="quienes-somos.html">¿Quienes somos?</a>
                    </li>
                    <li class="nav-item">
                        <a id="nav-link" class="nav-link navbar-brand" href="./socios/index.php">Socios</a>
                    <li class="nav-item">
                        <a id="nav-link" class="nav-link navbar-brand" href="./socios/index.php">Maquinaria</a>
                    </li>
                    <li class="nav-item">
                        <a id="nav-link" class="nav-link navbar-brand" href="productos.html">Productos</a>
                    </li>
                    <li class="nav-item">
                        <a id="nav-link" class="nav-link navbar-brand" href="noticias.html">Noticias</a>
                    </li>
                    <li class="nav-item">
                        <a id="nav-link" class="nav-link navbar-brand active" href="contactanos.html">Contactanos</a>
                    </li>
                </ul>
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a id="nav-link" class="nav-link" href="login">Iniciar sesion</a>
                    </li>
                    <li class="nav-item">
                        <a id="nav-link" class="nav-link" href="register">Registrarte</a>
                    </li>
                </ul>
            </div>
        </div>
