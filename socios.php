    ...
    <main class="row title-container m-auto" style="height: 400px;">
        ...
        <div class="col-md-6 d-flex justify-content-center flex-column ps-md-5 text-center text-md-start py-5 py-md-0">
            <div class="">
                ...
                <div class="title jus">
                    <h1 class="fs-1 text-dark">ASPAAH - Socios</h1>
                </div>
            </div>
        </div>
        <!-- Imagen Main-->
                ...
                <div class="row">
                    <div class="row px-5">
                        <p style="text-align: justify;">
                            ...
                            <h1>¿POR QUE SER SOCIO?</h1>
                            Los veneficios que usted tendrá al ser parten de la organización no solo se enfoca en la persona asociada, sino en toda su familia y el medio que lo rodea. Desde tener información de los usos correctos del sembrío, o crianza adecuada a los animales que se tenga. Los socios son la familia que hace posible que la organización avance  y crezca. 
                            </span>
                        </p>
                        <p style="text-align: justify;">
                            <span style="font-size: 12pt;">
                                <br>
                                <h1>PRIVILEGIOS DEL SOCIO</h1>
